  ...
  const quickActions = [
    {
      ...
      description: "Begin a practice interview with Rick",
      icon: Play,
      href: "/interview",
    ...
    <div className="interview-container">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Ready to practice your interview skills with Rick? Let's get started!
        </p>
      </div>
          ...
          {quickActions.map((action) => {
            ...
            return (
              ...
              >
                <div className="flex items-center">
                  <div
                    className={`p-3 rounded-lg ${action.color} ${action.textColor}`}
                  >
